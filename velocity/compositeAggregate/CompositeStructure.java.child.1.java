...
public class ${NAME}Controller {
	#if(${NAME} && ${NAME} != "")
	@Autowired private ${NAME}CompositeService service;
	...
	public ResponseEntity<ApiResponse<Flux<${NAME}Dto>>> searchCustomer(@PathVariable("page-no") int pageNo,
																   ...
																   @RequestBody Clean${NAME}Dto dto) {
	...
	@PatchMapping
	public ResponseEntity<ApiResponse<Mono<${NAME}Dto>>> partialUpdate${NAME}( @RequestBody Clean${NAME}Dto partialDto) {
