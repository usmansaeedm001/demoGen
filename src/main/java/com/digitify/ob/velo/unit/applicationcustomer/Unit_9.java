...
* @author ${USER}
*/
public interface ApplicationCustomerDtoMapper extends DtoMapper<ApplicationCustomerDto, ApplicationCustomerCreateDto, ApplicationCustomerSearchDto, ApplicationCustomerUpdateDto, ApplicationCustomerPartialUpdateDto> {
