		...
		**********/
		...
		Boolean existsByApplicationCustomerUuidAndUuidNotAndIsActiveTrue(String applicationCustomerUuid, String uuid);
				...
				**********/
				...
				Optional<BankAccount> findByAccountUuidAndApplicationCustomerUuid(String uuid, String principalUuid);
				Optional<BankAccount> findByAccountUuidAndApplicationCustomerUuidAndIsActiveTrue(String uuid, String principalUuid);
