...
* @author ${USER}
*/
public interface BankAccountDtoValidator extends DtoValidator<BankAccountCreateDto, BankAccountSearchDto, BankAccountUpdateDto, BankAccountPartialUpdateDto>  {
