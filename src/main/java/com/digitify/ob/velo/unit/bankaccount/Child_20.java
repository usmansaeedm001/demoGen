...
@Slf4j
@DataService
class BankAccountDataServiceImpl implements BankAccountDataService {
	...
	private List<BankAccountDto> processList(List<BankAccountDto> list, TrackCode trackCode,
											 Function<BankAccountDto, BankAccount> function) throws ApplicationUncheckException {
