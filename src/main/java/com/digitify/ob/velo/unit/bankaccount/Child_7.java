...
public enum BankAccountType implements Matchable {
...
BankAccountType(String code, String value) {
this.code = code;
this.value = value;
}
...
public static BankAccountType getType(String code) {
...
public static List<BankAccountType> getAllTypes() {
